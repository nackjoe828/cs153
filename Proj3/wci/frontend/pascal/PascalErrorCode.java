...
public enum PascalErrorCode
{
    ...
    INVALID_OPERATOR("Invalid operator"), //added
    INVALID_RANGE_OF_VALUES("Invalid range of values"), //added
    ...
    NON_UNIQUE_MEMBERS("non-unique members"), //added
